...
const { getUserProductsByDateController } = require('../../controllers/userProductsController');
const {
    postUserDiaryInfoController,
    getUserDiaryInfoController,
} = require('../../controllers/userDiaryInfoController');
const { createUserProductController } = require('../../controllers/userProductsController');
...
const { deleteDiaryListItem } = require('../../controllers/userProductsController');
